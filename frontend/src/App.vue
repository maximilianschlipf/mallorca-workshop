...
const totalTermine = computed(() =>
  schulungen.value.reduce(
    (sum, schulung) => sum + schulung.oeffentlicheTermine.length,
    0,
  ),
);
  ...
  <main class="page">
    <header id="top" class="site-header">
      <nav class="nav" aria-label="Hauptnavigation">
        <a class="brand" href="#top" aria-label="SimplyTest Academy Startseite">
        ...
        <div class="nav-links">
          ...
          <a class="nav-link" href="#trainer">Trainer finden</a>
        </div>
      </nav>
    </header>
